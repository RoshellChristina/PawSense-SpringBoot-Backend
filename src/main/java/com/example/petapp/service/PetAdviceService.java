...
public class PetAdviceService {
    ...
    public String generateAdvice(String emotion) {
        // Build request body
        ...
        List<Map<String, String>> messages = List.of(
                ...
                Map.of("role", "user", "content", "Give brief pet care advice if the dog is feeling "
                        + emotion + ", and provide sources to educational links as well.")
        );
